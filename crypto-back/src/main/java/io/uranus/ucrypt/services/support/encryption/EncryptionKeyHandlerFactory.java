...
public class EncryptionKeyHandlerFactory {
    ...
    public EncryptionKeyHandler getHandler(final EncryptionAlgorithm encryptionAlgorithm) {
        return (EncryptionKeyHandler) Optional.of(this.applicationContext.getBean(this.encryptionAlgorithmTypes.get(encryptionAlgorithm)))
