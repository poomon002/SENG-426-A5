...
@Component
public class TextEncryptionHandlerFactory {

    private final EnumMap<EncryptionAlgorithm, Class> encryptionAlgorithmTypes = new EnumMap<>(EncryptionAlgorithm.class);
    private final ApplicationContext applicationContext;

    public TextEncryptionHandlerFactory(final ApplicationContext applicationContext) {
    ...
    public TextEncryptionHandler getHandler(final EncryptionAlgorithm encryptionAlgorithm) {
        return (TextEncryptionHandler) Optional.of(this.applicationContext.getBean(this.encryptionAlgorithmTypes.get(encryptionAlgorithm)))
